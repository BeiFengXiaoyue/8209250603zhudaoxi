...
// ============================================================
// FavoriteButton — 收藏五角星（圆角 + 收藏数，风格匹配侧边栏）
// ============================================================
...
// ============================================================
// VideoInfoPanel — 视频基础信息模块（匹配数据库 B 规范）
// ============================================================
...
void PlayerWidget::setupUI()
{
    ...
    m_infoPanel->setCourseInfo("数据结构与算法 — 第3章：栈与队列详解",
                               "张老师", "2026/6/15");
    m_infoPanel->setDescription(
        "本课程系统讲解栈和队列的基本概念、顺序存储与链式存储结构、典型应用场景"
        "（表达式求值、括号匹配、循环队列等），并通过丰富的代码示例帮助理解。"
        "适合已掌握基础编程的学生。");
