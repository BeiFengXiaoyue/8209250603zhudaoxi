...
// ============================================================
// TeacherNavButton — 侧边栏导航按钮（QPainter 绘制几何图标）
// ============================================================
TeacherNavButton::TeacherNavButton(int iconType, const QString &text,
...
void TeacherNavButton::setActive(bool active)
{
    m_active = active;
    setChecked(active);
    applyStyle();
...
void TeacherNavButton::applyStyle()
{
    QString style = R"(
        QPushButton {
            background-color: %1;
...
void TeacherNavButton::paintEvent(QPaintEvent *event)
{
...
void TeacherNavButton::drawIcon(QPainter &painter, const QRect &rect)
{
    painter.save();
...
// ============================================================
// TeacherSidebar — 右侧导航侧边栏（教师版）
// ============================================================
TeacherSidebar::TeacherSidebar(QWidget *parent)
    : QWidget(parent)
{
    setupUI();
}

void TeacherSidebar::setActiveItem(int index)
{
...
void TeacherSidebar::setupUI()
{
    setFixedWidth(210);
    setStyleSheet("TeacherSidebar { background-color: #FFFFFF; border-radius: 15px; }");
    ...
    for (int i = 0; i < items.size(); ++i) {
        bool active = (i == 0);
        auto *btn = new TeacherNavButton(items[i].iconType, items[i].name, active);
