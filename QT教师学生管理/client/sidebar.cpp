...
// 图标颜色
// ============================================================
static const QColor kIconColor(80, 80, 80);
static const QColor kIconColorActive(59, 89, 152);
...
void Sidebar::setupUI()
{
    ...
    for (int i = 0; i < items.size(); ++i) {
        ...
        // TODO: connect btn clicked → setActiveItem(i) + emit itemClicked(i, name)
        //        - index == 1 (视频区) → 切换内容区至搜索页
        //        - index == 0 (个人中心) → 切换内容区至个人页
    ...
    auto *versionLabel = new QLabel("v1.0.0 · 视频播放");
